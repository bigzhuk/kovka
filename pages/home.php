...
<div class="container">
    ...
    <div class="adv_row">
        <div class="adv">
            <div class="icon"><i class="fa  fa-cogs fa-3x"></i><h3 style="color: black">Собственное производство</h3></div>
        ...
        <div class="adv">
            <div class="icon"><i class="fa fa-suitcase fa-3x"></i><h3 style="color: black">Комплекс работ под ключ</></div>
    ...
    <div class="adv_row">
        ...
        <div class="adv">
            <div class="icon"><i class="fa fa-money fa-3x"></i><h3 style="color: black">Фиксированная цена, гарантия</h3></div>
