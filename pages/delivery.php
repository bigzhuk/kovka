...
<div class="container">
	...
	<p><img src="images/img_kovka_4.jpg" class="left">
		...
		чтобы в процессе сотрудничества, вы получили желаемый результат "под ключ".
		<ul class="page_list" style="margin-left: 350px">
		<li>При заказе от 50 т.р. доставка по Москве и области производится  <u>бесплатно</u>.
		<li>При заказе менее 50 т.р. стоимость доставки от 200р. за каждые 10 км пути от производства.
