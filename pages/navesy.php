...
<div class="container">
	...
	<div>
		<div style="float: left;">
			<img src="images/navesy_small/naves_odnoskatniy.jpg" style="width: 250px; heifht: 125;  margin-left: 15px; border-radius: 3px;">
			<div align="center">Односкатные. <span style="color: #C42034">От 2400 за м²</span></div>
		</div>
		<div style="float: left;">
			<img src="images/navesy_small/naves_dvuskatniy.jpg" style="width: 250px; heifht: 125;  margin-left: 15px; border-radius: 3px;">
			<div align="center">Двускатные. <span style="color: #C42034">От 2500 за м²</span></div>
		</div>
		<div style="float: left;">
			<img src="images/navesy_small/naves_arochniy.jpg" style="width: 250px; heifht: 125;  margin-left: 15px; border-radius: 3px;">
			<div align="center">Арочные. <span style="color: #C42034">От 2500 за м²</span></div>
		</div>
		<div style="float: left;">
			<img src="images/navesy_small/naves_kovanniy.jpg" style="width: 250px; heifht: 125;  margin-left: 15px; border-radius: 3px;">
			<div align="center">Кованные. <span style="color: #C42034">От 4500 за м²</span></div>
		</div>
	</div>
	<div style="clear: both"></div>
	<h2>Навесы для автомобиля</h2>
	<p>Защитные сооружения из металлического каркаса, покрытого сотовым поликарбонатом – практичное и выгодное решение
