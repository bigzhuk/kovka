                ...
                $(el).magnificPopup({
                    ...
                    image: {
                        titleSrc: function(item) {
                            return '<div style="color: white;">«' + item.el.attr('title') + '». Заказать: <?= \App\Index::$phones[0]?>. <a style="color: white" href="/catalog?category_id=' + item.el.attr('data-category-id') + '&id=' + item.el.attr('id') + '"><div class="button" style="display: inline-block;">Подробнее</div></a></div>';
                        }
                    },
