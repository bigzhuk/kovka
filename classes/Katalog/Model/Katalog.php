...
class News {
    ...
    public function add($title, $short_text, $full_text, $date_publish_start, $date_publish_end) {
    ...
    public function updateById($id, $title, $short_text, $full_text, $date_publish_start, $date_publish_end) {
