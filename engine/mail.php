...
class SendMailSmtpClass {
    ...
    */   
    ...
    public function __construct($smtp_username = 'design@spartak.ru', $smtp_password = '192168cocacola', $smtp_host = 'ssl://smtp.yandex.ru', $smtp_from = 'sys-stroy.ru', $smtp_port = 465, $smtp_charset = "utf-8") {
